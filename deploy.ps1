...
aws cloudformation update-stack --stack-name house-finder-stack-2 --template-body file://C:/Users/Stuart/OneDrive/AWS/House-Finder/cloudFormation/lambda_cloud_formation_template.yaml --parameters ParameterKey=newFileName,ParameterValue=$new_fileName
